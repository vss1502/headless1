...
export default function SiteHeader ( {className}) {
    return (
      <header className={`container mx-auto lg:max-w-4xl flex items-center justify-between ${className}`}>
      <div className="logo-area">
        <Link href="/" className="flex justify-center">
          <Image src="/CoolNomad.svg" alt="Cool" width="180" height="120"></Image> 
        </Link>
      </div>
